#!/bin/bash
# Hobbiton Client Configuration (Ubuntu)
...
ifconfig eth0 10.76.15.130 netmask 255.255.255.224
route add default gw 10.76.15.128

echo "nameserver 192.168.122.1" > /etc/resolv.conf

echo "Hobbiton client configured successfully"
echo "IP: 10.76.15.130/27"
